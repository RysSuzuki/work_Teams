User.seed(
  :id,
  {id: 1, email: Faker::Internet.email, name: 'test1', password: 'password'},
  {id: 2, email: Faker::Internet.email, name: 'test2', password: 'password'},
  {id: 3, email: Faker::Internet.email, name: 'test3', password: 'password'},
  {id: 4, email: Faker::Internet.email, name: 'test4', password: 'password'},
  {id: 5, email: Faker::Internet.email, name: 'test5', password: 'password'},
  {id: 6, email: Faker::Internet.email, name: 'test6', password: 'password'},
  {id: 7, email: Faker::Internet.email, name: 'test7', password: 'password'},
  {id: 8, email: Faker::Internet.email, name: 'test8', password: 'password'},
  {id: 9, email: Faker::Internet.email, name: 'test9', password: 'password'},
